...
export const plans = [
  {
    ...
    price: "$250",
    cadence: "1 x 60-minute session per week · 4 sessions per month",
  ...
  },
  {
    ...
    price: "$450",
    cadence: "1 x 120-minute session per week · 4 sessions per month",
    ...
    features: [
      ...
      "A 10-minute break is included in each 120-minute session",
